...
import { useCreateSeaterRoomBookingMutation } from '../../../Redux/api/paymentApis';
import { useCheckExistingBookingsMutation } from '../../../Redux/api/singleRoomBookingsApis';

const CheckoutFormMultiseater = ({
  hostelId,
  amount,
  ownerId,
  roomNumber,
  ...
  const [createSeaterRoomBooking] = useCreateSeaterRoomBookingMutation();
...
export default CheckoutFormMultiseater;
