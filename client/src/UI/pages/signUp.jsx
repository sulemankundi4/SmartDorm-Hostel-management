...
const SignUp = () => {
  ...
  const { from } = location.state || { from: 'regularSingupBtn' };
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      !Password ||
      !ConfirmPassword ||
      (registrationType === 'student' && !University)
    ) {
    ...
    try {
      ...
      if (from === 'listYourProperty') {
        ...
        formData.Role = registrationType;
                ...
                <div className="mb-6">
                  <label
                    className={`mb-2.5 block font-medium text-black dark:text-white ${
                      registrationType === 'student' ? '' : 'hidden'
                    }`}
                    {...getLabelProps()}
                  >
                    University
                  ...
                  {loading ? (
                    <>
                      ...
                      <AiOutlineLoading3Quarters
                        className="animate-spin fa-solid fa-circle-notch"
                        size={20}
                      />
                    </>
                  ) : (
