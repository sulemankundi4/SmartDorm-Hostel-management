...
const { login, signUp, verifyEmail, googleAuth, redirect, getUserById, deletUser, getAllUsers, resendVerificationMail, getUserByUid } = require("../controllers/userController");
